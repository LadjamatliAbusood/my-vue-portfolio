<template>
    <section class="text-white mt-20" id="contact">
        ...
        <h2 class="text-4xl font-bold text-white text-center mb-4 px-4 xl:pl-16 ">Let's
            <span class="text-transparent bg-clip-text bg-gradient-to-r from-primary to-secondary">Connect</span>
        </h2>
        <div class="grid md:grid-cols-2 gap-4 relative px-4 xl:px-16 mt-8" data-aos="zoom-in-up">
            <div>
                
                <div class="col-lg-1 col-md-3 mb-lg-0 mt-5">
                    ...
                    <div class="flex mb-10 items-center">
                        ...
                        <div class="ml-5 text-white">
                            <h4>linked</h4>
                            <a href="https://www.linkedin.com/in/ajladjamatli/">Abusood Ladjamatli</a>
                        </div>
                    </div>
