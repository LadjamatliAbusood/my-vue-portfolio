<template>
  <section class="text-white mt-20" id="services">
    ...
    <div class="py-8 xl:px px-4 sm:py-16 grid grid-cols-1 gap-6 pt-10 sm:grid-cols-2 md:gap-10 md:pt-12 lg:grid-cols-3">
...
const services =ref([
    {
        id:1,
        icon:new URL('@/assets/res.png', import.meta.url).href,
        name:'WEB DEVELOPEMENT',
        description:'Building responsive and dynamic websites using modern frameworks and technologies.'
    },
    {
        id:2,
        icon: new URL('@/assets/android.png', import.meta.url).href,
        name:'Mobile DEVELOPEMENT',
        description:'Creating mobile applications for Android with seamless user experiences.'
    },
    {
        id:3,
        icon:new URL('@/assets/techsupport.png', import.meta.url).href,
        name:'Technical Support',
        description:'Basic Knowledgeable in troubleshooting computer hardware, software, and network issues.'
    ...
    },
    {
        ...
        description:'Have knowledge in Microsoft Office such as Microsoft Word, Excel and Power Point Presentation.'
    ...
    },
    {
        ...
        name:'Image Editing',
        description:'Photo retouching, manipulation, and enhancement using advanced editing tools.'
