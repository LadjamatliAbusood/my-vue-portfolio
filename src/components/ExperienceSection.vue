    ...
    <div class="md:grid md:grid-cols-2 gap-8 items-center py-8 px-4 xl:gap-16 xl:px-16">
        ...
        <div class="mt-4 md:mt-0 text-left flex flex-col z-10 h-full w-[80%]">
            ...
            <div class="mt-8" v-for="skills in Skills" :key="skills.id">
                ...
                <div class="mt-2 h-1 w-full bg-[#131d30] rounded-full">
                    <div class="h-1 rounded-full bg-primary" :style="`width :${skills.width}`"></div>
                </div>
            </div>
        </div>
        <!-- Right Side -->
        <div data-aos="flip-left">
            ...
            <div class="space-y-8 py-8" data-aos="fade-left">
                ...
                <div class="w-1/4">
                    <img :src="element.icon" alt="service icon">
                </div>
                <div class="w-3/4 pl-4">
                    <h3 class="text-2xl font-semibold uppercase text-trasparent bg-clip-text bg-gradient-to-r from-primary to-secondary">
                        {{ element.role }}
                    </h3>
                    <p class="text-white">{{ element.company }}</p>
                    <p class="text-white">{{ element.address }}</p>
...
const Experience = ref([
    {
        id:1,
        icon:new URL('@/assets/hospital.png', import.meta.url).href,
        role:'Jr Programmer',
        company:'West Metro Medical Center',
        address: 'Zamboanga City',
        date: 'April 2024 - August 2024'
    },
    {
        id:2,
        icon:new URL('@/assets/cityhall.png', import.meta.url).href,
        role:'Records Division',
        company:'Sangguniang Panlungsod ng Zamboanga',
        address: 'Zamboanga City',
